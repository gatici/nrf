...
type ConfClient interface {
	...
	PublishOnConfigChange(mdataFlag bool, host string) chan *protos.NetworkSliceResponse
	...
	subscribeToConfigPod(commChan chan *protos.NetworkSliceResponse, confClientHost string, newHost string)
}
...
func (confClient *ConfigClient) PublishOnConfigChange(mdataFlag bool, host string) chan *protos.NetworkSliceResponse {
	confClient.MetadataRequested = mdataFlag
	commChan := make(chan *protos.NetworkSliceResponse)
	confClient.Channel = commChan
	go confClient.subscribeToConfigPod(commChan, confClient.Host, host)
	return commChan
}
...
func (confClient *ConfigClient) subscribeToConfigPod(commChan chan *protos.NetworkSliceResponse, confClientHost string, newHost string) {
